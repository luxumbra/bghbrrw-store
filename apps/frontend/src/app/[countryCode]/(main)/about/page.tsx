...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!page) {
    return {
      title: 'About Us - Bough & Burrow',
      description: 'Learn more about Bough & Burrow and our story.',
    }
  }
  ...
  return {
    ...
    description: seo?.metaDescription || 'Learn more about Bough & Burrow and our story.',
